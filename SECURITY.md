...
→ https://github.com/SysAdminDoc/Cataclysm/security/advisories/new
...
- Supply-chain risk in pinned npm / Cargo dependencies (please prefer
  filing via [GitHub Dependabot alerts](https://github.com/SysAdminDoc/Cataclysm/security/dependabot)
