# Project Research and Feature Plan — v0.4.0 forward

> **Third companion** in the series. The earlier plans are still valid for their respective time-windows and **not duplicated** here:
>
> - [`RESEARCH_FEATURE_PLAN.md`](./RESEARCH_FEATURE_PLAN.md) — v0.0.1 baseline (scaffold-era competitive research, NUKEMAP / Asteroid Launcher / NOAA MOST / GeoClaw / FUNWAVE-TVD / JAGURS landscape). Still accurate.
> - [`RESEARCH_FEATURE_PLAN_v0.3.0.md`](./RESEARCH_FEATURE_PLAN_v0.3.0.md) — written 2026-05-25 against `ef90dc8` (v0.2.1). Defined F-V01..F-V13 + I-V01..I-V10. Of these, **15 shipped on `main`** during the autonomous Phase 0.3.0 batch (see below); 5 remain blocked on maintainer input.
> - [`ROADMAP.md`](./ROADMAP.md) — canonical phased plan. Reflects current shipping state.
>
> This document is the **v0.4.0 forward-looking research and feature plan**, focused on Phase 4 (GPU + nonlinear), Phase 5 (Boussinesq + AMR), and Phase 6 (UX polish + v1.0.0), plus the Phase 0.3 items still blocked on inputs only the maintainer can supply.
>
...
*End of research and feature plan v0.4.0+. Generated 2026-05-25 against commit `28d9242`. Companion to:*
- *[`RESEARCH_FEATURE_PLAN.md`](./RESEARCH_FEATURE_PLAN.md) — v0.0.1 competitive landscape*
- *[`RESEARCH_FEATURE_PLAN_v0.3.0.md`](./RESEARCH_FEATURE_PLAN_v0.3.0.md) — v0.3.0 forward plan (15 of 23 items shipped during the autonomous batch)*
- *[`ROADMAP.md`](./ROADMAP.md) — canonical phased plan*
