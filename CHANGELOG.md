...
- Updated `event-listener` to its patched 5.4.2 release and refreshed the time-bounded Rust advisory review for inherited scientific-data caches.
...
- Added Rust-authoritative firestorm screening for qualifying nuclear and
