...
const ES_MESSAGES: MessageCatalog = {
  ...
  "guided.close": "Cerrar lección",
  "guided.print": "Imprimir hoja",
...
const JA_MESSAGES: MessageCatalog = {
  ...
  "guided.close": "レッスンを閉じる",
  "guided.print": "ワークシートを印刷",
...
const ID_MESSAGES: MessageCatalog = {
  ...
  "guided.close": "Tutup pelajaran",
  "guided.print": "Cetak lembar kerja",
  "guided.printTitle": "Cetak lembar kerja kelas dengan pertanyaan pelajaran ini",
  "guided.back": "Kembali",
  "guided.next": "Berikutnya",
  "guided.done": "Selesai",
