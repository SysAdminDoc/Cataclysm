...
seven lesson narratives and worksheets, the scenario library and playback
controls, and the scientific glossary are translated now. Advanced interface
text that has not yet moved to the catalog falls back to canonical English.
