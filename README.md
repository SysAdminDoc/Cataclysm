...
an MSI package and an NSIS setup executable. The v0.13.0 Windows installers are
...
```powershell
# PowerShell
(Get-FileHash .\Cataclysm_0.13.0_x64_en-US.msi -Algorithm SHA256).Hash
```

```cmd
:: Command Prompt
certutil -hashfile Cataclysm_0.13.0_x64_en-US.msi SHA256
```
