...
NM.WW3_TARGETS_US = [
  {name:'Malmstrom AFB',lat:47.5050,lng:-111.1872,type:'icbm',warheads:8,yieldKt:800,cat:'341st Missile Wing, 150 Minuteman III silos across central Montana'},
  {name:'Minot AFB',lat:48.4159,lng:-101.3306,type:'icbm',warheads:8,yieldKt:800,cat:'91st Missile Wing, 150 Minuteman III silos across North Dakota'},
  ...
  {name:'Whiteman AFB',lat:38.7289,lng:-93.5605,type:'bomber',warheads:2,yieldKt:455,cat:'509th Bomb Wing, all 19 B-2 Spirit stealth bombers, nuclear-capable'},
  ...
  {name:'Dyess AFB',lat:32.4185,lng:-99.8565,type:'military',warheads:1,yieldKt:300,cat:'7th Bomb Wing, B-1B Lancers (conventional only, de-nuclearized under START I)'},
  ...
  {name:'Naval Base Kitsap-Bangor',lat:47.7195,lng:-122.7191,type:'sub',warheads:3,yieldKt:800,cat:'Pacific Fleet Trident base, 8 Ohio-class SSBNs, SWFPAC nuclear weapons facility'},
  {name:'Naval Submarine Base Kings Bay',lat:30.7968,lng:-81.5328,type:'sub',warheads:3,yieldKt:800,cat:'Atlantic Fleet Trident base, 6 Ohio-class SSBNs, SWFLANT nuclear weapons facility'},
  {name:'Cheyenne Mountain Complex',lat:38.7443,lng:-104.8468,type:'c2',warheads:2,yieldKt:455,cat:'NORAD/USNORTHCOM alternate command center, deep underground bunker'},
  ...
  {name:'Offutt AFB',lat:41.1243,lng:-95.9146,type:'c2',warheads:2,yieldKt:455,cat:'US Strategic Command (USSTRATCOM) headquarters, E-4B Nightwatch base'},
  {name:'The Pentagon',lat:38.8719,lng:-77.0563,type:'c2',warheads:3,yieldKt:800,cat:'Department of Defense headquarters, National Military Command Center'},
  ...
  {name:'Raven Rock Mountain Complex (Site R)',lat:39.7340,lng:-77.4190,type:'c2',warheads:2,yieldKt:455,cat:'Alternate National Military Command Center, underground Pentagon backup'},
  {name:'Mount Weather EOC',lat:39.0645,lng:-77.8899,type:'c2',warheads:2,yieldKt:455,cat:'FEMA continuity of government facility, presidential fallout shelter'},
  {name:'Camp David',lat:39.6483,lng:-77.4650,type:'c2',warheads:2,yieldKt:455,cat:'Presidential retreat, near Raven Rock, hardened communications'},
  {name:'Tinker AFB',lat:35.4148,lng:-97.3866,type:'c2',warheads:2,yieldKt:455,cat:'E-6B Mercury TACAMO base, nuclear communications relay to submarines'},
  ...
  {name:'Schriever Space Force Base',lat:38.8033,lng:-104.5256,type:'c2',warheads:2,yieldKt:455,cat:'Satellite command & control for 170+ DoD satellites, missile warning'},
  {name:'Buckley Space Force Base',lat:39.7010,lng:-104.7510,type:'c2',warheads:2,yieldKt:455,cat:'Space-based infrared missile warning, intelligence processing'},
  {name:'Pantex Plant',lat:35.3116,lng:-101.5597,type:'nuclear',warheads:1,yieldKt:300,cat:'Only US nuclear weapons assembly/disassembly facility, Amarillo TX'},
  ...
  {name:'Sandia National Laboratories (NM)',lat:35.0507,lng:-106.5431,type:'nuclear',warheads:1,yieldKt:300,cat:'Non-nuclear weapons components R&D, Kirtland AFB, Albuquerque NM'},
  ...
  {name:'Kansas City National Security Campus',lat:38.9581,lng:-94.5689,type:'nuclear',warheads:1,yieldKt:300,cat:'Electronic, mechanical & material components for nuclear weapons'},
  {name:'Nevada National Security Site',lat:37.1167,lng:-116.0500,type:'nuclear',warheads:1,yieldKt:300,cat:'Former nuclear test site, subcritical experiments, stockpile stewardship'},
  {name:'Kirtland AFB',lat:35.0403,lng:-106.6092,type:'nuclear',warheads:1,yieldKt:300,cat:'Largest nuclear weapons storage area in US (Manzano/Coyote Canyon), Sandia base'},
  ...
  {name:'MacDill AFB (CENTCOM/SOCOM)',lat:27.8493,lng:-82.5212,type:'military',warheads:1,yieldKt:300,cat:'US Central Command & Special Operations Command headquarters, Tampa FL'},
  {name:'Fort Liberty',lat:35.1392,lng:-78.9992,type:'military',warheads:1,yieldKt:300,cat:'XVIII Airborne Corps, Army Special Operations Command, 52,000+ personnel (renamed from Fort Bragg 2023)'},
  {name:'Fort Hood (Fort Cavazos)',lat:31.1363,lng:-97.7797,type:'military',warheads:1,yieldKt:300,cat:'III Corps, 1st Cavalry Division, largest active-duty armored post'},
  ...
  {name:'Naval Station Norfolk',lat:36.9474,lng:-76.3169,type:'military',warheads:1,yieldKt:300,cat:'World\'s largest naval station, Fleet Forces Command HQ, 75+ ships'},
  ...
  {name:'Travis AFB',lat:38.2721,lng:-121.9399,type:'military',warheads:1,yieldKt:300,cat:'Largest Air Mobility Command base on West Coast, strategic airlift'},
  {name:'Fairchild AFB',lat:47.6188,lng:-117.6483,type:'military',warheads:1,yieldKt:300,cat:'KC-135 tanker base, survival school, strategic refueling support'},
  ...
  {name:'Fort Eisenhower (formerly Gordon)',lat:33.4170,lng:-82.1350,type:'military',warheads:1,yieldKt:300,cat:'US Army Cyber Center of Excellence, signals intelligence training'},
  {name:'Redstone Arsenal',lat:34.6849,lng:-86.6530,type:'military',warheads:1,yieldKt:300,cat:'Army missile/aviation, Space & Missile Defense Command, Huntsville AL'},
  {name:'Wright-Patterson AFB',lat:39.8261,lng:-84.0483,type:'military',warheads:1,yieldKt:300,cat:'Air Force Materiel Command HQ, National Air & Space Intel Center'},
  ...
  {name:'Houston Ship Channel Refinery Complex',lat:29.7500,lng:-95.0800,type:'infra',warheads:1,yieldKt:300,cat:'Multiple refineries, 2.6M bbl/day capacity, Baytown/Deer Park/Pasadena'},
  {name:'Port Arthur Refinery Complex',lat:29.9000,lng:-93.9300,type:'infra',warheads:1,yieldKt:300,cat:'Motiva (607K bbl/day), Valero (435K bbl/day), TotalEnergies refineries'},
  ...
  {name:'Los Angeles Basin Refineries',lat:33.8900,lng:-118.2400,type:'infra',warheads:4,yieldKt:800,cat:'Multiple refineries, Marathon, Valero, Phillips 66, Torrance/Carson/Wilmington'},
  {name:'San Francisco Bay Refineries',lat:38.0200,lng:-122.2300,type:'infra',warheads:1,yieldKt:300,cat:'Chevron Richmond, Marathon Martinez, PBF Martinez, Valero Benicia'},
  // Non-strategic infrastructure: dams, power grid, data centers
  {name:'Grand Coulee Dam',lat:47.9555,lng:-118.9815,type:'infra',warheads:1,yieldKt:300,cat:'Largest US hydroelectric dam, 6.8 GW capacity, Columbia River'},
  {name:'Hoover Dam',lat:36.0161,lng:-114.7377,type:'infra',warheads:1,yieldKt:300,cat:'2.1 GW hydroelectric, supplies water/power to NV/AZ/CA'},
  {name:'Glen Canyon Dam',lat:36.9375,lng:-111.4858,type:'infra',warheads:1,yieldKt:300,cat:'1.3 GW hydroelectric, Lake Powell, Colorado River system'},
  {name:'Oroville Dam',lat:39.5378,lng:-121.4847,type:'infra',warheads:1,yieldKt:300,cat:'Tallest US dam (235m), 0.8 GW, California water supply'},
  {name:'Palo Verde Nuclear Plant',lat:33.3881,lng:-112.8617,type:'infra',warheads:1,yieldKt:300,cat:'Largest US nuclear power plant, 3.9 GW, supplies AZ/CA/NM'},
  {name:'South Texas Nuclear Plant',lat:28.7950,lng:-96.0489,type:'infra',warheads:1,yieldKt:300,cat:'2.7 GW nuclear power, Gulf Coast grid critical infrastructure'},
  {name:'Ashburn VA Data Center Alley',lat:39.0438,lng:-77.4874,type:'infra',warheads:1,yieldKt:300,cat:'World\'s largest data center cluster, 70%+ US internet traffic'},
  {name:'The Dalles OR Data Center Hub',lat:45.5946,lng:-121.1787,type:'infra',warheads:1,yieldKt:300,cat:'Major Google/Amazon data center campus, Columbia River cooling'},
  {name:'PJM Interconnection Hub',lat:40.3165,lng:-75.9325,type:'infra',warheads:1,yieldKt:300,cat:'Largest US power grid operator, serves 65M people across 13 states'},
  ...
  {name:'Denver-Aurora-Lakewood',lat:39.7392,lng:-104.9903,type:'city',warheads:3,yieldKt:800,cat:'Pop ~3.0M, near Buckley SFB, Schriever SFB, Cheyenne Mountain'},
  ...
  {name:'Hartford-East Hartford-Middletown',lat:41.7658,lng:-72.6734,type:'city',warheads:2,yieldKt:800,cat:'Pop ~1.2M, Pratt & Whitney (jet engines), submarine parts manufacturing'},
  ...
  {name:'Albuquerque, NM',lat:35.0844,lng:-106.6504,type:'city',warheads:1,yieldKt:300,cat:'Pop ~920K, Kirtland AFB, Sandia Labs, major nuclear weapons complex'},
  {name:'New Haven-Milford, CT',lat:41.3083,lng:-72.9279,type:'city',warheads:1,yieldKt:300,cat:'Pop ~870K, Electric Boat submarine manufacturing (Groton nearby)'},
  ...
  {name:'Augusta-Richmond County, GA-SC',lat:33.4735,lng:-81.9748,type:'city',warheads:1,yieldKt:300,cat:'Pop ~620K, Fort Eisenhower (Army Cyber), near Savannah River Site'},
...
NM.WW3_TARGETS_RU = [
  ...
  {name:'Kartaly (decommissioned)',lat:53.9667,lng:57.8333,type:'icbm',warheads:0,yieldKt:455,cat:'Former SS-18 deployment site, Chelyabinsk Oblast. Decommissioned — not targeted.'},
  {name:'Aleysk (decommissioned)',lat:52.5000,lng:82.7500,type:'icbm',warheads:0,yieldKt:455,cat:'Former 41st Guards Missile Division, 30 SS-18 silos destroyed. Decommissioned — not targeted.'},
  ...
  {name:'Vilyuchinsk (Rybachiy) - Pacific Fleet SSBN Base',lat:52.9200,lng:158.4900,type:'sub',warheads:3,yieldKt:455,cat:'Borei-class SSBNs, Kamchatka Peninsula. Russia\'s largest sub'},
  {name:'Severodvinsk - Sevmash Shipyard',lat:64.5817,lng:39.8307,type:'sub',warheads:3,yieldKt:455,cat:'Russia\'s only nuclear submarine construction facility. 30,00'},
  {name:'Engels-2 Air Base',lat:51.4753,lng:46.2063,type:'bomber',warheads:2,yieldKt:455,cat:'Russia\'s sole Tu-160 base + Tu-95MS. 22nd Guards Heavy Bombe'},
  ...
  {name:'Moscow Kremlin - Presidential Command',lat:55.7520,lng:37.6175,type:'c2',warheads:2,yieldKt:455,cat:'Russian President\'s official residence and office, supreme n'},
  ...
  {name:'Sarov (Arzamas-16) - VNIIEF',lat:54.8167,lng:43.3667,type:'nuclear',warheads:1,yieldKt:300,cat:'Russia\'s primary nuclear warhead design institute + Avangard'},
  ...
  {name:'Seversk (Tomsk-7) - Siberian Chemical Combine',lat:56.6167,lng:84.8333,type:'nuclear',warheads:1,yieldKt:300,cat:'Russia\'s largest plutonium production & fissile material com'},
...
NM.WW3_TARGETS_NATO = [
  ...
  {name:'SHAPE (Supreme HQ Allied Powers Europe)',lat:50.5050,lng:3.9700,type:'c2',warheads:2,yieldKt:300,cat:'NATO\'s military HQ at Casteau near Mons. SACEUR commands all'},
  ...
  {name:'MARCOM Northwood',lat:51.6130,lng:-0.4140,type:'c2',warheads:2,yieldKt:300,cat:'Allied Maritime Command. NATO\'s one-stop shop for maritime o'},
  ...
  {name:'HMNB Clyde (Faslane)',lat:56.0609,lng:-4.8211,type:'nuclear',warheads:2,yieldKt:300,cat:'Home of UK Vanguard-class Trident SSBNs. Britain\'s continuou'},
...
NM.WW3_TARGETS_CN = [
  ...
  {name:'Xi\'an Yanliang (XAC/CFTE)',lat:34.6446,lng:109.2430,type:'bomber',warheads:2,yieldKt:455,cat:'H-6 manufacturing/test facility. Xi\'an Aircraft Industrial C'},
  ...
  {name:'Lanzhou Enrichment Plant (Plant 504)',lat:36.1481,lng:103.5235,type:'nuclear',warheads:1,yieldKt:300,cat:'China\'s largest uranium enrichment facility. GDP operational'},
