...
- [ ] **I-V01 P1** — Wet/dry land cell handling in SWE solver (no more "halo" on continental land).
...
- [ ] **F-V10 P2** — Radiation / sponge-layer boundary conditions (replace zero-flux walls).
